...
\include{./sintelo/sintelo}

% \bibliographystyle{plain} % especifica o estilo como as refer?ncias s?o formatadas
% \bibliography{bibliografia} % especifica o arquivo que cont?m todas as refer?ncias catalogadas, de acordo com a sintaxe de um arquivo .bib.
\end{document}